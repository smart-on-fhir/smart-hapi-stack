...
import org.smartplatforms.demo.interceptor.RequestInterceptor;
...
public class JpaServerDemo extends RestfulServer {
	...
	protected void initialize() throws ServletException {
		...
		/*
		 * Create the SMART request interceptor
		 */
		IServerInterceptor requestInterceptor = myAppCtx.getBean(IServerInterceptor.class, "mySmartRequestInterceptor");
		this.registerInterceptor(requestInterceptor);
